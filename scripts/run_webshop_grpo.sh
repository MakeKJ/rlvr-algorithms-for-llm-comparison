...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='grpo_qwen2.5_1.5b_run_1' \
    ...
    trainer.rollout_data_dir=/home/marjuntt/multi_turn_rl/verl_agent_project/environments/webshop/rollout_dump/dump_grpo_run_1
